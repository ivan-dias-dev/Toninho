...
//
router.post("/cadastraProduto", verificarToken, async (req, res) => {
...
//atualiza o produto
router.put("/:productId",verificarToken, async (req, res) => {
  try {
    let produtoAtualizado = await userService.updateProduct(req.params.productId, req.body);
